...
namespace FXServer.My
{
	...
	internal sealed class MyProject
	{
		...
		internal sealed class MyForms
		{
			...
			[EditorBrowsable(EditorBrowsableState.Never)]
			public FXServer m_FXServer;

			public FXServer FXServer
			{
				[DebuggerHidden]
				get
				{
					m_FXServer = Create__Instance__(m_FXServer);
					return m_FXServer;
				}
				[DebuggerHidden]
				set
				{
					if (value != m_FXServer)
					{
						...
						Dispose__Instance__(ref m_FXServer);
					}
				}
			}
			...
			{
				if (((Control)(Instance?)).get_IsDisposed() ?? true)
				{
